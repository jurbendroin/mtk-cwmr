...
int main(int argc, char** argv)
{
    ...
    strcat(tmp, "-cmdline");
    write_string_to_file((char*)tmp, (char*)header.cmdline);
    ...
    //read kernel header
    byte* kernel_head = (byte*)malloc(512);
    fread(kernel_head, 512,1,f);
    total_read += 512;
    ...
    total_read += header.kernel_size-512;
    ...
    //read ramdisk header
    byte* ramdisk_head = (byte*)malloc(512);
    fread(ramdisk_head, 512,1,f);
    total_read += 512;
    ...
    total_read += header.ramdisk_size-512;
